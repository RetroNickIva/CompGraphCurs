...
//функция округление до целого для зарисовки
...
//алгоритм быстрой отрисовки линии с поддержкой интерполяции Z координаты
...
void OBJ_Processor::draw_filled_triangle(const int & vertex_id, const QRgb &edge_color) {
    ...
    //получаем точки треугольника по индексу
    ...
    //быстрый алгоритм линии, чтобы у краев тоже была Z координата
